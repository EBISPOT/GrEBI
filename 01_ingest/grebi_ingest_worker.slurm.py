...
def main():
    ...
    cmd = cmd + ' | ' + shlex.quote(datasource_file['datasource']['ingest_script'])
    ...
    for param in datasource_file['datasource']['ingest_args']:
    ...
    cmd = 'sort -o ' + shlex.quote(sorted_nodes_jsonl_filename) + ' ' + shlex.quote(nodes_jsonl_filename)
