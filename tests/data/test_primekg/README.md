...
PrimeKG stores MONDO, HPO, GO and UBERON ids without their leading zeros).

## Provenance

`kg.csv` is the header plus seven rows copied verbatim from
...
`uberon:0000002`, ...). In the built graph each PrimeKG node and its ontology
