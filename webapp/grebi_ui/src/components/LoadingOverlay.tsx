...
export default function LoadingOverlay({ message, scoped }: { message?: string; scoped?: boolean }) {
  return (
    <div className={`${scoped ? "absolute" : "fixed"} top-0 left-0 w-full h-full z-50`}>
